...
class CausalInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        print(f"{str(self.__class__)}: wan_mode={get_wan_version(str(self.__class__))}, self.num_transformer_blocks={self.num_transformer_blocks}, self.frame_seq_length={self.frame_seq_length}")
    ...
    def inference(
        ...
        for current_num_frames in tqdm.tqdm(all_num_frames):
            ...
            for index, current_timestep in enumerate(self.denoising_step_list):
                ...
                # print(f"kv_cache['local_end_index']: {self.kv_cache1[0]['local_end_index']}")
                # print(f"kv_cache['global_end_index']: {self.kv_cache1[0]['global_end_index']}")

...
class WanVAEWrapper(torch.nn.Module):
    def __init__(self):
        ...
        #     pretrained_path="/m2v_intern/raozejing/StreamingCode/DiffSynth-Studio-1.1.8/models/Wan-AI/Wan2.1-T2V-1.3B/Wan2.1_VAE.pth",
        #     z_dim=16,
        # ).eval().requires_grad_(False)
...
class WanDiffusionWrapper(torch.nn.Module):
    def __init__(
        ...
        # else:
        #     self.model = WanModel.from_pretrained(f"/m2v_intern/raozejing/StreamingCode/DiffSynth-Studio-1.1.8/models/Wan-AI/{model_name}/")
        # self.model.eval()
        ...
        self.seq_len = get_seq_frame_len(return_seq=True, return_frame=False, caller=str(self.__class__))  # [1, 21, 16, 60, 104]
        self.post_init()
    ...
    def forward(
        ...
        input_timestep = timestep
        #print('input_timestep: ',input_timestep)

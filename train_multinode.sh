...
# --- Script arguments ---
CONFIG=configs/ar_diffusion_tf_chunkwise_5b_720p_only_HOIGen_dataset_new_bs32.yaml
LOGDIR=logs/ar_diffusion_chunkwise_5b_720p_only_HOIGen_dataset_new_bs32
mkdir -p $LOGDIR

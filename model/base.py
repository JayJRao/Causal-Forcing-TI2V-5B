...
class BaseModel(nn.Module):
    ...
    def _initialize_models(self, args, device):
        ...
        self.generator = _DiffusionWrapper(**getattr(args, "model_kwargs", {}), is_causal=self.iscausal)
        self.generator.model.requires_grad_(True)

        self.real_model_name = getattr(args, "real_name", "Wan2.1-T2V-1.3B")
        self.real_score = _DiffusionWrapper(model_name=self.real_model_name, is_causal=False)
        self.real_score.model.requires_grad_(False)

        self.fake_model_name = getattr(args, "fake_name", "Wan2.1-T2V-1.3B")
        self.fake_score = _DiffusionWrapper(model_name=self.fake_model_name, is_causal=False)
